...
## Short video on how to decode your first contract on Dune
...
4. Give the project a name, ex. this could be the name of your NFT collection. 
5. Leave the contract name as is. Ignore the toggles for "Enable bytecode matching" and "Decode other contracts created by the same factory" if you just want to track the stats on your own contract.
5. Once submitted, it can take up to 24 hours for Dune to complete decoding.
