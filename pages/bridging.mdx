...
<br></br>
Popular faucet options to acquire Arbitrum Sepolia:
<li>[Alchemy](https://www.alchemy.com/faucets/arbitrum-sepolia)</li>
<li>[QuickNode](https://faucet.quicknode.com/arbitrum/sepolia)</li>


<Callout type="warning">Most faucets now require a user's wallet to hold at least 0.001 ETH on Ethereum Mainnet to use the EVM faucets to help prevent bot attacks.</Callout>
...
Once you confirm within the Transaction tab you should see the following 
 ...
 You will be prompted to switch from the Arbitrum Sepolia network to the Curtis Network
...
<Callout type="info"> Click on the red dot to the right of the amount and then on the sushi and finalize the withdrawal.</Callout>

![bridge](../images/confirmed.png)


 Now that you have finalized the withdrawal you will see your balance has updated and you have successfully bridged. 
