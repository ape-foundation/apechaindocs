...
**Enviroment** on the left-hand side (see below) and switch to the Curtis Network where you can deploy/interact with your contract, this time on testnet as opposed to the VM.
