...
- ⚠️ ***Your BAYC/MAYC/BAKC shadow will be your staking key on ApeChain*** ⚠️. Use delegation responsibly as the delegated wallet has the rights to withdraw deposited $APE from the staking contract.
