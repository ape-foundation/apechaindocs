...
- **Adding Apechain Testnet to MetaMask:**
    - You can find and add chain details [here](https://jenkins.hub.caldera.xyz/) to your Metamask.
- **Obtaining Test ETH (Sepolia) and Bridging to Apechain Testnet:**
    - Visit [https://jenkins.hub.caldera.xyz/](https://jenkins.hub.caldera.xyz/)
    - Click on “Faucet”
...
When deploying smart contract to any chain, you need to pay deployment gas fee using the chain’s native token and it is no difference for Apechain, before deploying to Apechain you need to make sure that you need to make sure that you have apecoin testnet.
...
```jsx
forge create --rpc-url "https://jenkins.rpc.caldera.xyz/http" --private-key `your-private-key` FileName.sol:ContractName
```

You should see a similar response like the one below

[https://lh7-us.googleusercontent.com/docsz/AD_4nXc1mU_MeG7Gf2TBFQDRWJe5-mE08uYIsEOlBC7dwv-OjGEO151MqkB5OyMZtoKTL5OYC1zIhApfLpyRreGkD6V-VNXtsIMoZsHMCytMzA4UqwgW7v4w1vehL_tHkDcWkdOSg7vzroAaQuIXPCC5AHjUvWG6?key=W3r7znJOFbRPcyG60XmZSA](https://lh7-us.googleusercontent.com/docsz/AD_4nXc1mU_MeG7Gf2TBFQDRWJe5-mE08uYIsEOlBC7dwv-OjGEO151MqkB5OyMZtoKTL5OYC1zIhApfLpyRreGkD6V-VNXtsIMoZsHMCytMzA4UqwgW7v4w1vehL_tHkDcWkdOSg7vzroAaQuIXPCC5AHjUvWG6?key=W3r7znJOFbRPcyG60XmZSA)
...
Visit [Apechain’s explorer](https://jenkins.explorer.caldera.xyz/), copy and paste your contract address into the search bar and you should be able to see your smart contract and every other
