...
3. Add your network to Metamask using these parameters from Jenkins Testnet:
    - Network Name: Jenkins
    - New RPC URL: https://jenkins.rpc.caldera.xyz/http
    - Chain ID: 1798
    - Currency Symbol: APE
    - Block Explorer URL: https://jenkins.explorer.caldera.xyz/
